export default {
    ...
    "mj": {
        ...
        "infoStar": 'Ce projet est open source sur <a class="text-blue-600 dark:text-blue-500" href="https://HeiGPT.com/Dooy/chatgpt-web-midjourney-proxy\" target="_blank">HeiGPT</a>, gratuit et basé sur la licence MIT sans aucune forme de paiement ! </p><p>Si vous trouvez ce projet utile, veuillez lui donner une étoile sur HeiGPT, merci !',
