...
,`gpt-4-vision-preview`,'gpt-4-all','gpt-3.5-net','bing','gemini-pro','claude-2.1','Code Interpreter','glm-4','gpt-4-browsing','midjourney','midjourney-relax','midjourney-turbo']
,maxToken:2048
});
