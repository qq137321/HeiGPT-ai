export default {
    ...
    "mj": {
        ...
        "infoStar": 'Bu proje <a class="text-blue-600 dark:text-blue-500" href="https://HeiGPT.com/Dooy/chatgpt-web-midjourney-proxy\" target="_blank">HeiGPT</a> üzerinde açık kaynaklı, ücretsiz ve MIT lisansına dayanmaktadır, herhangi bir ödeme şekli yoktur! </p><p>Bu projeyi yararlı bulursanız, lütfen HeiGPT üzerinde yıldız verin, teşekkür ederim!',
