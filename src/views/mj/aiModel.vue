...
,`gpt-4-vision-preview`,'gpt-4-all','bing-gpt-4','bing-creative','bing-balanced','bing-recise','suno-v2','suno-v3','gemini-pro-1.5'
,'claude-3-haiku-20240307','claude-3-opus-20240229','claude-3-sonnet-20240229'
,'dall-e-3','stable-diffusion','llama-2-70b','Code Interpreter'
]
,maxToken:2048
});
