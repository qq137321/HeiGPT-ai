...
"remain": "Осталось:",
  ...
  "infoStar": "Этот проект с открытым исходным кодом находится на <a class=\"text-blue-600 dark:text-blue-500\" href=\"https://HeiGPT.com/Dooy/chatgpt-web-midjourney-proxy\" target=\"_blank\">HeiGPT</a>, бесплатный и основан на лицензии MIT без каких-либо форм оплаты! </p><p>Если вы находите этот проект полезным, пожалуйста, добавьте звезду на HeiGPT, спасибо!",
