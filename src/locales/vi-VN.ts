export default {
  ...
  "mj": {
    ...
    "infoStar": "Dự án này được mở nguồn tại <a class=\"text-blue-600 dark:text-blue-500\" href=\"https://HeiGPT.com/Dooy/chatgpt-web-midjourney-proxy\" target=\"_blank\">HeiGPT</a>, miễn phí và dựa trên giấy phép MIT mà không có bất kỳ hình thức thanh toán nào! </p><p>Nếu bạn thấy dự án này hữu ích, hãy cho nó một sao trên HeiGPT, cảm ơn bạn!",
