export default {
  ...
  "modleSuccess": "模型成功載入",
    ...
    "infoStar": "此專案在 <a class=\"text-blue-600 dark:text-blue-500\" href=\"https://HeiGPT.com/Dooy/chatgpt-web-midjourney-proxy\" target=\"_blank\">HeiGPT</a> 上以 MIT 協議開源，免費且沒有任何付費行為！ </p><p>如果你覺得這個專案對你有幫助，請在 HeiGPT 上給它一顆星，謝謝！",
    "setBtSaveChat": "僅保存對話",
    "setBtSaveSys": "保存至系統",
    "wsrvClose": "關閉 wsrv",
    "wsrvOpen": "開啟 wsrv",
