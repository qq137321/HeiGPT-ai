export default {
  ...
  mj:{
    ...
    ,infoStar:'此项目开源于 <a  class="text-blue-600 dark:text-blue-500" href="https://HeiGPT.com/Dooy/chatgpt-web-midjourney-proxy" target="_blank"> HeiGPT </a>，免费且基于 MIT 协议，没有任何形式的付费行为！ </p><p>如果你觉得此项目对你有帮助，请在 HeiGPT 帮我点个 Star，谢谢！'
    ,setBtSaveChat:'仅保存会话'
    ,setBtSaveSys: '保存至系统'
