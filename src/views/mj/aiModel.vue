...
,`gpt-4-vision-preview`,'gpt-4-all','gpt-4-browsing','Precise','Balanced','Creative','gemini-pro'
,'gemini-pro-vision','claude-1.3','claude-2.1','llama-2-70b','Code Interpreter'
,'glm-4','dall-e-2','dall-e-3','stable-diffusion','midjourney','midjourney-relax','midjourney-turbo'
