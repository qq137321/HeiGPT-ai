...
const config = ref({
model:[ 'gpt-3.5-turbo',`gpt-3.5-turbo-16k`,'gpt-4','gpt-4-32k','gpt-4o','gpt-4o-mini','gpt-4o-2024-05-13','gpt-4-turbo','gpt-4-turbo-2024-04-09','gpt-4-1106-preview','gpt-4-0125-preview'
,`gpt-4-vision-preview`,'gpt-4-all','bing-creative','bing-balanced','bing-recise','suno-v2','suno-v3','gemini-pro-1.5'
,'claude-3-haiku-20240307','claude-3-opus-20240229','claude-3-5-sonnet-20240620'
,'dall-e-3','stable-diffusion','Code Interpreter'
]
,maxToken:2048
});
