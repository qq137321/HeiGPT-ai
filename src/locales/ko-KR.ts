export default {
  ...
  "mj": {
    ...
    "infoStar": "이 프로젝트는 <a class=\"text-blue-600 dark:text-blue-500\" href=\"https://HeiGPT.com/Dooy/chatgpt-web-midjourney-proxy\" target=\"_blank\">HeiGPT</a>에서 오픈 소스로 제공되며 MIT 라이선스를 기반으로 하며 어떠한 유료 행위도 없습니다! </p><p>이 프로젝트가 도움이 되었다면 HeiGPT에서 별을 주시기 바랍니다. 감사합니다!",
