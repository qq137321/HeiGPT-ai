...
const config = ref({
model:[ 'gpt-3.5-turbo',`gpt-3.5-turbo-16k`,'gpt-4','gpt-4-32k','gpt-4-1106-preview','gpt-4-0125-preview','gpt-4-turbo-preview'
,`gpt-4-vision-preview`,'gpt-4-all','bing','gemini-pro'
,'gemini-pro-vision','claude-2.1','claude-3-haiku-20240307'
