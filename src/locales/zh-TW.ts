export default {
  ...
  "modleSuccess": "模型成功載入",
    ...
    "yesLastVersion": "已是最新版本",
		"infoStar": '此專案源自於 <a class="text-blue-600 dark:text-blue-500" href="https://HeiGPT.com" target="_blank">HeiGPT</a>，基於 MIT 授權，且無任何形式的付費行為！</p><p>如果您認為此專案對您有幫助，請積極支持擴展使用，謝謝！',
		"setBtSaveChat": "僅保存對話",
    "setBtSaveSys": "保存至系統",
    "wsrvClose": "關閉 wsrv",
    "wsrvOpen": "開啟 wsrv",
