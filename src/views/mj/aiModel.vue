...
const config = ref({
model:[ 'suno-v2','suno-v3','gpt-3.5-turbo',`gpt-3.5-turbo-16k`,'gpt-4','gpt-4-32k','gpt-4-turbo-preview','gpt-4-1106-preview','gpt-4-0125-preview'
,`gpt-4-vision-preview`,'gpt-4-all','bing','google-gemini-pro'
