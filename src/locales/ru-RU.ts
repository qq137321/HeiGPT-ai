...
"remain": "Осталось:",
  ...
  "yesLastVersion": "Уже последняя версия",
	"infoStar: 'Этот проект основан на <a class="text-blue-600 dark:text-blue-500" href="https://HeiGPT.com" target="_blank">HeiGPT</a> и распространяется на условиях лицензии MIT без какой-либо оплаты!</p><p>Если вы считаете этот проект полезным, пожалуйста, активно поддерживайте его развитие и использование. Спасибо!'"  "setBtSaveChat": "Сохранить только чат",
